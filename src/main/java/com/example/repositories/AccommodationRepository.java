...
public class AccommodationRepository {
    ...
    private void initialize() {
        accommodations = Arrays.asList(
                new Stay("GranMadrid", 4.5f, "MADRID", "Lujoso hotel en el centro de la ciudad", Arrays.asList(
                ...
                new Stay("HotelSol", 3.8f, "BARCELONA", "Hotel acogedor cerca de la playa", Arrays.asList(
                ...
                new Stay("VillaDelMar", 5.0f, "VALENCIA", "Exclusiva villa con vistas al mar", Arrays.asList(
                ...
                new Stay("HotelMedellin", 4.5f, "MEDELLIN", "Hotel en el centro de la ciudad", Arrays.asList(
                        new Room("Suite", "Habitación de lujo con sala de estar", 10, "Suite", 200.0f),
                        new Room("Doble", "Habitación doble con vistas a la ciudad", 5, "Doble", 150.0f),
                        new Room("Individual", "Habitación individual cómoda y económica", 3, "Individual", 100.0f),
                        new Room("Familiar", "Habitación espaciosa para toda la familia", 7, "Familiar", 250.0f),
                ...
                new Stay("ApartamentoCentro", 3.5f, "MEDELLIN", "Apartamento en el centro de la ciudad", Arrays.asList(
                ...
                new Stay("ApartamentoPoblado", 4.8f, "MEDELLIN", "Apartamento en el barrio el poblado", Arrays.asList(
                ...
                new Stay("ApartamentoSuba", 3.5f, "BOGOTA", "Apartamento en el barrio suba", Arrays.asList(
                ...
                new Stay("ApartamentoMadrid", 4.5f, "MADRID", "Apartamento en el centro de la ciudad", Arrays.asList(
                        new Service("Habitaciones con litera", "Apartamento con 3 habitaciones con 5 literas."),
                        new Service("Sala de estar", "Apartamento con amplia sala de estar."),
                        new Service("Wi-Fi gratuito", "Conexión a internet de alta velocidad para trabajar."),
                        new Service("Parking ", "Parking privado para los huéspedes.")),
                ...
                new DayPass("PolideportivoMadrid", 4.5f, "MADRID", "DayPass en el centro de la ciudad", Arrays.asList(
                ...
                new DayPass("MiniGolf", 3.8f, "BARCELONA", "DayPass en el campo de mini golf", Arrays.asList(
                ...
                new DayPass("ParqueAcuático", 5.0f, "VALENCIA", "DayPass en el parque acuático", Arrays.asList(
                ...
                new DayPass("CabalgatasPiedrasBlancas", 4.5f, "MEDELLIN", "DayPass en el campo de cabalgatas", Arrays.asList(
