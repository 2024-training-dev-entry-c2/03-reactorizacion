...
public class Data {
    ...
    public static List<Accommodation> addHotels() {
        ...
        Hotel hotel1 = new Hotel("La Habana", "Hotel", Arrays.asList(room1, room2, room3, room4, room5), new ArrayList<>(), 4.5f, "Hotel Nacional de Cuba");
        Hotel hotel2 = new Hotel("Varadero", "Hotel", Arrays.asList(room1, room2, room3, room4, room5),  new ArrayList<>(),4.7f, "Meliá Cohíba");
        Hotel hotel3 = new Hotel("Ciego de Ávila", "Hotel", Arrays.asList(room1, room2, room3, room4, room5), new ArrayList<>(),4.6f, "Resort Playa Coco");
    ...
    public static List<Accommodation> addLands() {
        ...
        Land land1 = new Land("Colonia", "Finca", Arrays.asList(room1, room2, room3, room4, room5), new ArrayList<>(),4.0f, "Finca Colonia");
        Land land2 = new Land("Pinar del Río", "Finca", Arrays.asList(room1, room2, room3, room4, room5),  new ArrayList<>(),4.2f, "Finca Pinar del Río");
    ...
    public static List<Accommodation> addApartment() {
        ...
        Apartment apartment1 = new Apartment("La Habana", "Apartamento", Arrays.asList(room1, room2, room3, room4, room5),  new ArrayList<>(), 4.3f, "Apto Habana");
        Apartment apartment2 = new Apartment("Ciego de Ávila", "Apartamento", Arrays.asList(room1, room2, room3, room4, room5),  new ArrayList<>(), 4.7f, "Apto Ciego");
    ...
    public static List<Accommodation> addSunnyDay() {
        ...
        SunnyDay sunnyDay1 = new SunnyDay("Cabo Polonio", "Día de Sol", List.of(roomBeachfront) , new ArrayList<>(), 5.0f, "Cabo Polonio Experience", true, true);
        SunnyDay sunnyDay2 = new SunnyDay("La Paloma", "Día de Sol", List.of(roomPoolside),  new ArrayList<>(), 4.9f, "La Paloma Sun", false, true);
        SunnyDay sunnyDay3 = new SunnyDay("Varadero", "Día de Sol", List.of(roomGardenView),  new ArrayList<>(),4.8f, "Varadero Dream", true, false);
        SunnyDay sunnyDay4 = new SunnyDay("Playa Blanca", "Día de Sol", List.of(roomOceanView), new ArrayList<>(),5.0f, "Playa Blanca Paradise", true, true );
        SunnyDay sunnyDay5 = new SunnyDay("Cuba Libre", "Día de Sol", List.of(roomTropical), new ArrayList<>(),4.7f, "Cuba Libre Beach", false, true);
