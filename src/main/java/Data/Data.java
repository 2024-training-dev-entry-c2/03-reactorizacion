...
public class Data {
    ...
    private static Room createRoom(String description, String roomType, Double basePrice, Integer capacityMinors, Integer capacityAdults, Integer amountRooms, LocalDate... dates) {
        return new Room(description, roomType, basePrice, capacityMinors, capacityAdults, amountRooms, new HashSet<>(Arrays.asList(dates)));
    }

    private static List<Room> createCommonRooms() {
